...
class AlipayBank_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_return_url = get_domain().APP_ROOT.'/shop.php?ctl=payment&act=response&class_name=AlipayBank';
		$data_notify_url = get_domain().APP_ROOT.'/shop.php?ctl=payment&act=notify&class_name=AlipayBank';
		...
		$payLinks = '<a href="https://mapi.alipay.com/gateway.do?'.$param. '&sign='.$sign_md5.'&sign_type=MD5" target="_blank"><span class="paybutton" name="buy">'.sprintf($this->payment_lang['GO_TO_PAY'],$this->get_name($bank_type)).'</span></a>';
