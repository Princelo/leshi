...
<script type="text/javascript">
 ...
 <body>
	...
	<div style="width:225px;height:290px;margin:10px;overflow:hidden; float:left;"><img  style="float:left;" id="preview2" src="<?php echo $players_big_img; ?>" ></div>
    <form action="players_image_edit_admin.php?act=cut&players_id=<?php echo $_GET['players_id'];?>" method="post" onsubmit="return checkCoords();">
		<input type="hidden" id="x" name="x" />
		<input type="hidden" id="y" name="y" />
		<input type="hidden" id="w" name="w" />
		<input type="hidden" id="h" name="h" />
        <input type="hidden" id="<?php echo $_GET['players_id']; ?>" name="<?php echo $_GET['players_id']; ?>" />
