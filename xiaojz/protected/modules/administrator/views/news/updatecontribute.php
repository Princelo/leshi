...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                <span style="float:left">当前位置是：赞助单位>修改信息</span>
                <span style="float:right;margin-right: 8px;font-weight: bold">
                    <a style="text-decoration: none" href="./index.php?r=administrator/news/showcontribute">【返回】</a>
                </span>
            </span>
        </div>
        <div></div>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
           ...
           <?php $form = $this -> beginWidget('CActiveForm'); ?>
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                    <td>
                        <?php echo $form -> labelEx($news_model, 'news_content'); ?>
                    </td>
