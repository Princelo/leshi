			...
			function setPage(url){
				...
				if(typeof(cache[url])=="undefined"){
					...
					ajax.get(url,function(data){
							obj.innerHTML=data;
                            $(document).ready(function(){$('#images-show a').lightBox();});
...
<div id="logo"><img src="<?php echo IMG_URL; ?>logo.png" alt="" /></div>
    ...
    <ul class="menu-out">
        <li class="current"><a href="<?php echo SITE_URL; ?>">首页</a></li>
        <li>
    ...
    <a class="signup" href="<?php echo SITE_URL; ?>?r=sub/signup"></a>
</div>
