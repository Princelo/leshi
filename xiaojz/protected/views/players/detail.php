        ...
        <div class="block clearfix">
                ...
                <div style="display: block;" class="box" id="history_div">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix"><li class="playersimg"><a href="#" target="_blank"><img src="<?php echo IMG_URL; ?>8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue"></a></li><li><a href="#" target="_blank" title="飞利浦9@9v">飞利浦9@9v</a><br />本店售价：<font class="f1">￥399元</font><br /></li></ul><ul class="clearfix"><li class="playersimg"><a href="#" target="_blank"><img src="<?php echo IMG_URL; ?>9_thumb_G_1241511871555.jpg" alt="<?php echo $players_info->players_name; ?>" class="B_blue"></a></li><li><a href="#" target="_blank" title="<?php echo $players_info->players_name; ?>"><?php echo $players_info->players_name; ?></a><br />本店售价：<font class="f1">￥2298元</font><br /></li></ul><ul class="clearfix"><li class="playersimg"><a href="#" target="_blank"><img src="<?php echo IMG_URL; ?>17_thumb_G_1241969394587.jpg" alt="夏新N7" class="B_blue"></a></li><li><a href="#" target="_blank" title="夏新N7">夏新N7</a><br />本店售价：<font class="f1">￥2300元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </div>
                    </div>
                </div>
            ...
            <div class="AreaR">
                <div id="playersInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="<?php echo IMG_URL; ?>200905/players_img/9_P_1241511871575.jpg" id="zoom1" class="MagicZoom MagicThumb" title="<?php echo $players_info->players_name; ?>">
                            <img id="sim806035" src="<?php echo $players_info->players_big_img; ?>" alt="<?php echo $players_info->players_name; ?>" height="310px" width="310px;" />
                            <div class="MagicZoomBigImageCont" style="width: 200px; height: 269px; overflow: hidden; z-index: 100; visibility: visible; position: absolute; top: -10000px; left: 327px; display: block;" id="bc806035">
                                <div style="position: relative; z-index: 10; left: 0px; top: 0px; padding: 3px;" id="MagicZoomHeaderbc806035" class="MagicZoomHeader"><?php echo $players_info->players_name; ?>
                                </div>
                        ...
                        <div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="<?php echo IMG_URL; ?>200905/players_img/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/players_img/9_P_1241511871575.jpg" title="">
                                <img src="<?php echo IMG_URL; ?>9_thumb_P_1241511871787.jpg" alt="<?php echo $players_info->players_name; ?>" class="onbg" /></a>
                        </div>
                    </div>
                    ...
                    <div class="textInfo">
                        <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            <div class="clearfix" style="font-size: 14px; font-weight: bold; padding-bottom: 8px;">
                                <?php echo $players_info->players_name; ?>      
                            </div>
                            <ul>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品库存：</strong>
                                        <?php echo $players_info->players_number; ?> 台             
                                    </dd>
                                </li>  
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品重量：</strong><?php echo $players_info->players_weight; ?>克       
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：</strong><?php echo date('Y-m-d',$players_info->players_create_time); ?>      
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>市场价格：</strong><font class="market">￥<?php echo $players_info->players_price; ?>元</font><br />

                                        <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥<?php echo $players_info->players_price; ?>元</font><br />
                                        <strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥<?php echo $players_info->players_price; ?>元</font><br />
                                        <strong>vip：</strong><font class="shop" id="ECS_RANKPRICE_2">￥<?php echo $players_info->players_price; ?>元</font><br />
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div id="com_v" class="boxCenterList RelaArticle">
                            <p>在机身材质方面，<?php echo $players_info->players_name; ?>大量采用金属材质，刨光的金属表面光泽动人，背面的点状效果规则却又不失变化，时尚感总是在不经意间诠释出来，并被人们所感知。E66机身尺寸为<span style="color:red;"><span style="font-size: larger;"><strong>107.5×49.5×13.6毫米，重量为121克</strong></span></span>，滑盖的造型竟然比E71还要轻一些。</p>
                            <p>&nbsp;</p>
                            <div><?php echo $players_info->players_name; ?>机身正面是<span style="color:red;"><span style="font-size: larger;"><strong>一块2.4英寸1600万色QVGA分辨率（240×320像素）液晶显示屏</strong></span></span>。屏幕上方拥有光线感应元件，能够自适应周 围环境光调节屏幕亮度；屏幕下方是方向功能键区。打开滑盖，可以看到传统的数字键盘，按键的大小、手感、间隔以及键程适中，手感非常舒适。</div>
                            <div>&nbsp;</div>
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <form name="tagForm"   id="tagForm">
                                ...
                                <p>
                                    ...
                                    <input name="players_id" value="9" type="hidden" />
                                </p>
                            </form>
                        </div>
                    </div>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <div class="playersItem">
                                <a href="#">
                                    <img src="<?php echo IMG_URL; ?>24_thumb_G_1241971981429.jpg" alt="P806" class="playersimg"></a><br />
                                <p><a href="#" title="P806">P806</a></p> 
                                <font class="shop_s">￥2000元</font>
                            </div>
                            <div class="playersItem">
                                <a href="#">
                                    <img src="<?php echo IMG_URL; ?>22_thumb_G_1241971076803.jpg" alt="多普达Touch HD" class="playersimg" /></a><br />
                                <p><a href="#" title="多普达Touch HD">多普达Touc...</a></p> 
                                <font class="shop_s">￥5999元</font>
                            </div>
                            <div class="playersItem">
                                <a href="#">
                                    <img src="<?php echo IMG_URL; ?>13_thumb_G_1241968002527.jpg" alt="诺基亚5320 XpressMusic" class="playersimg" /></a><br />
                        ...
                        <div class="box_1">
                            ...
                            <div class="boxCenterList">
                                ...
                                <div id="buy_pagebar" class="f_r" style="margin-top: 10px;">
                                    <form name="selectPageForm" action="/players.php" method="get">
                                        <div id="buy_pager">
