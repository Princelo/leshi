...
<div class="mini-banner2"><img src="images/grey.gif" data-original="<?php echo UPLOADS_URL; ?>mini-banner2.jpg" alt=""></div>
    <div class="bread-block">
        ...
        <div class="category">
            <label>请选择分类</label>
            <a class="categoryall" href="javascript:setPage('<?php echo SITE_URL ?>?r=ajax/fetchall&battle=1');">全部</a>
            <a class="category1" href="javascript:setPage('<?php echo SITE_URL ?>?r=ajax/fetchone&battle=1');">分类一</a>
            <a class="category2" href="javascript:setPage('<?php echo SITE_URL ?>?r=ajax/fetchtwo&battle=1');">分类二</a>
            <a class="category3" href="javascript:setPage('<?php echo SITE_URL ?>?r=ajax/fetchthree&battle=1');">分类三</a>
            <a class="category4" href="javascript:setPage('<?php echo SITE_URL ?>?r=ajax/fetchfour&battle=1');">分类四</a>
        </div>
    </div>
    ...
    <script>setPage("<?php echo SITE_URL; ?>?r=ajax/fetchall&page=1&battle=1");</script>
    </div>
    <div style="clear:both"></div>
    <div class="photo-ad">
