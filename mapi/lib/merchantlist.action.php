...
class merchantlist
{
	public function index()
	{
		...
		$sql = "select a.supplier_id as id,a.name,a.mobile_brief as brief,a.tel,a.preview as logo,a.xpoint,a.ypoint,a.address as api_address, 0 as is_dy $field_append from   ".DB_PREFIX."supplier_location as a ";
