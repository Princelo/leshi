...
class mobile_uc_accountModule extends ShopBaseModule
{
    public function index()
    {
        ...
        set_uc_right();
        $GLOBALS['tmpl']->assign("inc_file","mobile/inc/uc/mobile_uc_account_index.html");
        $GLOBALS['tmpl']->display("mobile_uc.html");
    }
