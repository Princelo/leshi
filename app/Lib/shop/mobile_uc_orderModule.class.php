...
class mobile_uc_orderModule extends ShopBaseModule
{
    public function index()
    {
        ...
        $GLOBALS['tmpl']->display("mobile/mobile_uc_order.html");
    }
    ...
    public function view()
    {
        ...
        $GLOBALS['tmpl']->display("mobile/mobile_uc_order_view.html");
    }
    ...
    public function modify()
    {
        ...
        {
            app_redirect(url("shop","uc_money#incharge"));
        }
        $GLOBALS['tmpl']->assign('order_info',$order_info);
