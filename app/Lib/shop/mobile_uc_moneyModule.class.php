...
class mobile_uc_moneyModule extends ShopBaseModule
{
    ...
    public function index()
    {
        ...
        $GLOBALS['tmpl']->assign("inc_file","mobile/inc/uc/mobile_uc_money_index.html");
        $GLOBALS['tmpl']->display("mobile/mobile_uc.html");
    }
    ...
    public function incharge()
    {
        ...
        $GLOBALS['tmpl']->assign("inc_file","mobile/inc/uc/mobile_uc_money_incharge.html");
        $GLOBALS['tmpl']->display("mobile/mobile_uc.html");
    }
