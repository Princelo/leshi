...
class mobile_cartModule extends ShopBaseModule
{
    public function index()
    {
        make_delivery_region_js();
        $GLOBALS['tmpl']->caching = true;
        $cache_id  = md5(MODULE_NAME.ACTION_NAME.intval($_REQUEST['id']).$GLOBALS['deal_city']['id']."_mobile");
        ...
        $GLOBALS['tmpl']->display("mobile/mobile_cart_index.html",$cache_id);
    }
