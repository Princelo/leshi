...
class mobile_storeModule extends YouhuiBaseModule
{
    public function index()
    {
        ...
        $GLOBALS['tmpl']->display("mobile/mobile_store_index.html");
    }
...
//		
    ...
    public function ajax_get_tuan()
    {
        ...
        $GLOBALS['current_url'] = url("youhui","store#ajax_get_tuan",$upara);
        $page = new Page($count,$page_size);   //初始化分页对象
        $p  =  $page->show();
        $GLOBALS['tmpl']->assign('pages',$p);
        $GLOBALS['tmpl']->assign("list",$list);
        $GLOBALS['tmpl']->display("inc/store_ajax_get_tuan.html");
    }

    public function ajax_get_shang()
    {
        require_once APP_ROOT_PATH."app/Lib/page.php";
        $type = addslashes($_REQUEST['type']);
        $location_id = intval($_REQUEST['id']);
        ...
        $GLOBALS['current_url'] = url("youhui","store#ajax_get_shang",$upara);
        $page = new Page($count,$page_size);   //初始化分页对象
        $p  =  $page->show();
        $GLOBALS['tmpl']->assign('pages',$p);
        $GLOBALS['tmpl']->assign("list",$list);
        $GLOBALS['tmpl']->display("inc/store_ajax_get_shang.html");
    }
