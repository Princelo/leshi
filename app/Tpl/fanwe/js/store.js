...
$(document).ready(function(){
	$(".ext_nav").find("li").bind("click",function(){
		load_store_extra_shang($(this).attr("rel"),"s");
		load_store_extra_tuan($(this).attr("rel"),"t");
...
function load_store_extra_shang(location_id,type)
{
	$.ajax({ 
		url: APP_ROOT+"/youhui.php?ctl=store&act=ajax_get_shang&is_ajax=1&id="+location_id+"&type="+type ,
		type: "POST",
		success:function(result){
			$(".detail_cnt_shang").find("#extra_info_shang").html(result);
			$(".detail_cnt_shang").find("#extra_info_shang").show();
...
function load_store_extra_tuan(location_id,type)
{
	$.ajax({ 
		url: APP_ROOT+"/youhui.php?ctl=store&act=ajax_get_tuan&is_ajax=1&id="+location_id+"&type="+type ,
		type: "POST",
		success:function(result){
			$(".detail_cnt_tuan").find("#extra_info_tuan").html(result);
			$(".detail_cnt_tuan").find("#extra_info_tuan").show();
