        ...
        jQuery.event.special.submit = {
            setup: function(data, namespaces, fn) {
                if (this.nodeName.toLowerCase() !== "form") {
                    jQuery.event.add(this, "click.specialSubmit." + fn.guid,
                        function(e) {
                            var elem = e.target,
                                type = elem.type;
                    ...
                    jQuery.event.add(this, "keypress.specialSubmit." + fn.guid,
                        function(e) {
                            var elem = e.target,
                                type = elem.type;
    ...
    jQuery.each(["bind", "one"],
        function(i, name) {
            jQuery.fn[name] = function(type, data, fn) {
                ...
                return type === "unload" && name !== "one" ? this.one(type, data, fn) : this.each(function() {
        ...
        function(i, name) {
            jQuery.fn[name] = function(types, data, fn) {
                ...
                while ((type = types[i++]) != null) {
                    type = type === "focus" ? "focusin": type === "blur" ? "focusout": type === "hover" ? types.push("mouseleave") && "mouseenter": type;
                    if (name === "live") {
...
$(document).ready(function() {
    try {
        if (!isNaN(version) && false) {
            $.getJSON('http://mi.7dit.com/o2olicense.php?version=' + version + '&callback=?',
                function(data) {
